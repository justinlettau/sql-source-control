...
module.exports = {
    ...
    getConfig: function () {
        ...
        if (!config.connection) {
            console.log(`Required property 'connection' is missing from the config file!`);
        }
    ...
    getWebConfigConn: function (file) {
        ...
        const webConfig = file || this.webConfigFile;
        let content;
        let conn;
        ...
        parser.parseString(content, (err, result) => {
            ...
            const cs = result.configuration.connectionStrings[0].add[0].$.connectionString.split(';');
